...
namespace HomeWork_15
{
    ...
    public partial class WindowTransferToClient : Window
    {
        ...
        private ObservableCollection<Client> GetClients()
        {
            ...
            foreach (var individual in this.window.Individuals.Clients)
            {
            ...
            foreach (var legalEntity in this.window.LegalEntities.Clients)
            {
        ...
        private void Transfer(object sender, RoutedEventArgs e)
        {
            ...
            MainWindow.StartActionLogs($"Клиент {this.client.FullName} выполнил перевод перевод средств" +
